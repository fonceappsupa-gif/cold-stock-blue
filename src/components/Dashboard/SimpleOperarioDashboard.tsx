    ...
    <div className="min-h-screen bg-slate-950">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <Badge className="bg-cyan-500/20 text-cyan-100 border-cyan-500/50">Operario</Badge>
            </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="space-y-6">
          {/* Header */}
          <div>
            <h1 className="text-3xl font-bold text-white">Dashboard de Operario</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            ...
            <Card className="glass-card border-cyan-500/20 hover:border-cyan-500/50 transition-all duration-300 hover:scale-105">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-white">Movimientos Hoy</CardTitle>
                <TrendingUp className="h-4 w-4 text-cyan-400" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold text-white">{stats.recentMovements}</div>
                <p className="text-xs text-cyan-200">
                  Registros del día
                </p>
              </CardContent>
